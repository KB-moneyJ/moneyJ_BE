...
public class TransactionFacade {
    ...
    @Transactional
    public void processTransactions(Long userId, TransactionRequestDTO request) {
        ...
        applicationEventPublisher.publishEvent(new TransactionRequestEvent(userId, request));
    }
}
