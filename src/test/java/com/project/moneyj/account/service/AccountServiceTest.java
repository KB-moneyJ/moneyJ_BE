...
public class AccountServiceTest {
    ...
    void linkUserAccountTest1(){
        ...
        //when
        AccountLinkResponseDTO response = accountService.linkUserAccount(userId, request);
    ...
    void switchAccountTest(){
        ...
        // when
        AccountLinkResponseDTO res = accountService.switchAccount(userId, accountId, req);
        ...
        // 마스킹 결과가 DTO에 반영되는지
        assertEquals(AccountService.maskAdvanced("9999-0000-1111"), res.getAccountNumberDisplay());
